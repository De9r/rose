...
if UserId == 1160471152 then
Status = true
elseif UserId == 1160471152 then
Status = true
...
if tonumber(msg.sender.user_id) == 1160471152 then
msg.Name_Controller = 'Ace🎖 '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1160471152 then
msg.Name_Controller = 'Ace🎖'
msg.The_Controller = 1
...
{
{text = 'قناة السورس', url='https://t.me/cn_world'},
},
}
}
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/cn_world'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
download('https://raw.githubusercontent.com/De9r/rosebot/main/FDFGERB.lua','FDFGERB.lua')
...
local Get_Is_Id = Get_Is_Id:gsub('#الفلوس',NumberGames) 
...
{
{text = 'قناة السورس',url="t.me/cn_world"}
},
}
...
if text == "ولد" or text == "صور و" then 
Abs = math.random(2,140); 
...
if text == "بنات" or text == "صور ب" then 
Abs = math.random(2,140); 
...
if text == "رسم" or text == "افتار رسم" then 
Abs = math.random(2,140); 
local Text ='• تم اختيار افتار رسم'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/cn_worls"}
},
}
local msg_id = msg.id/2097152/0.5
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/cn_worls/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end


if text == "متحركه" or text == "متحركة" then 
Abs = math.random(2,1300); 
local Text ='• تم اختيار المتحرك لك'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/cn_world"}
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendanimation?chat_id=' .. msg.chat_id .. '&animation=https://t.me/awaww/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end


if text == "ريمكس" or text == "ريماكس" then 
Abs = math.random(2,270); 
...
if text == "انمي" or text == "صور ا" then 
Abs = math.random(2,140); 
...
data = {
{
{text = '❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓🎖 ❳', url = "https://t.me/jj8jjj8"}
},
{
{text = '- السورس .', url = "https://t.me/cn_world"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[Rose Source .](t.me/cn_world)\n\n[سورس روز ،](t.me/cn_world)","md",true, false, false, false,reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"[ReBack Source .](t.me/cn_world)\n\n[سورس روز ،](t.me/cn_world)","md",true, false, false, false,reply_markup)
end
...
LuaTele.sendText(msg.chat_id,msg.id, "\n• وسوينا لك حساب في البنك ( الرشيد . 💳 )  \n\n• رقم حسابك ↢ ( `"..creditcc.."` )\n• نوع البطاقة ↢ ( "..gg.." )\n• فلوسك ↢ ( `"..flossst.."` دينار 💲 )  ","md",true)  
end 
...
if text == 'تصفير النتائج' or text == 'تصفير الكل' then
if msg.ControllerBot then
...
return LuaTele.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح به هو 5000 دينار \n-","md",true)
end
ballancee = Redis:get(FDFGERB.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:sadd(FDFGERB.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 دينار 💸","md",true)
end
local jjjo = "500000"
Redis:incrby(FDFGERB.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(FDFGERB.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دينار 💸","md",true)
...
if text == "روز" or text == "بوت" then
LuaTele.sendText(msg.chat_id,msg.id, "نعم؟","كول شتريد","ها حياتي","عيوني ياعيوني","وياك روزة كول","md",true)
end
...
return LuaTele.sendText(msg.chat_id,msg.id, "• ماتكدر تزرفه فلوسه اقل من 2000  دينار 💲","md",true)
end
...
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف فلوس (%d+)$"))  
...
if Num == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id, "• لم تفز بأي دينار ","md",true)  
else
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'مم','رفع مميز')
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','مسح')
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'ردود','الردود')
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'م م','مسح المكتومين')
...
{
{text = 'تحديثات البوت', url = 't.me/cn_world'}, 
},
}
}
...
{
{text = 'تحديثات لبوت', url = 't.me/cn_world'}, 
},
}
}
...
━ فلوسي ← لعرض عدد الارباح
━ بيع فلوسي ←  العدد  ← لبيع كل دينار مقابل {50} رساله
━━━━━━━━━━━━━━━
]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local bank_users = Redis:smembers(FDFGERB.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(FDFGERB.."zrffdcf"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
